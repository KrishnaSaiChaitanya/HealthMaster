...
const Products = () => {
  ...
  useEffect(() => {
    ...
    const storedCart = JSON.parse(window.localStorage.getItem(`cartItems_${customerId}`));
    if (storedCart) {
  ...
  const updateCartItems = (updatedCart) => {
    ...
    window.localStorage.setItem(`cartItems_${customerId}`, JSON.stringify(updatedCart));
  };
    ...
    if (customerId) {
      try {
        ...
        const response = await fetch('http://localhost:8081/addToCart', {
          ...
          body: JSON.stringify({ customerid: customerId, productdata: productdata }),
              ...
              data.map((products, idx) => {
                ...
                return <div key={products.productid} className="col-md-12 col-lg-3 mb-4 mb-lg-0 xs:mx-2">
                  ...
                  <div className="card mb-4" style={{ minWidth: "200px", minHeight: "470px", maxHeight: "470px" }}>
                    {click && <ClickedProduct play={play} AddToCart={AddToCart} cartItems={cartItems} setClick={setClick} />}
              ...
              <div className="clickedproduct-main mb-5 d-flex justify-content-center">
                <div className="clicked-product-card mt-3 d-flex justify-content-center mb-5 text-start ">
                  <div className="w-50 ">
                    ...
                    <div>
                      <img src={products.recipeimage} className="w-100 mt-4" alt={products.recipename} />
                    </div>
                    <div className="mb-5">
